...
export class Convert {
  public static toIPokeInfo(json: string): IPokeInfo {
    return cast(JSON.parse(json), r('IPokeInfo'))
  }

  public static iPokeInfoToJson(value: IPokeInfo): string {
    return JSON.stringify(uncast(value, r('IPokeInfo')), null, 2)
  }
}
